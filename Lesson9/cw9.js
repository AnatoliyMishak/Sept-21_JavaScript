...
//     surnameDiv.innerText = `${person.surname}`
//
//     let ageDiv = document.createElement('div')
//     ageDiv.innerText = `${person.age}`
//
//     let infoDiv = document.createElement('div')
//     infoDiv.innerText = `${person.info}`
//
//     let img = document.createElement('img')
//     img.src = `${person.photo}`
//
//
// simpsonDiv.appendChild(nameDiv)
// simpsonDiv.appendChild(surnameDiv)
// simpsonDiv.appendChild(ageDiv)
// simpsonDiv.appendChild(infoDiv)
// simpsonDiv.appendChild(img)
//     document.body.appendChild(simpsonDiv)
// }
...
for (let element of coursesArray) {
    ...
    durationMonthDiv.innerText = `${element.monthDuration}`

    let durationHourDiv = document.createElement('div')
    durationHourDiv.innerText = `${element.hourDuration}`

    let durationDiv = document.createElement('div')
    durationDiv.append(durationMonthDiv, durationHourDiv)
    durationDiv.style.display = 'flex'
    durationMonthDiv.style.width = '25%'
    durationHourDiv.style.width = '75%'
    ...
    coursesDiv.appendChild(durationDiv)
