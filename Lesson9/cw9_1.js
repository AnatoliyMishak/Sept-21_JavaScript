...
for (let element of coursesArray) {
    ...
    let monthHoursDiv = document.createElement('div');
    monthHoursDiv.style.display = 'flex'
    let monthSubDiv = document.createElement('div');
    monthSubDiv.innerText = `${element.monthDuration}`
    monthSubDiv.style.width = '30%'
    let hoursSubDiv = document.createElement('div');
    hoursSubDiv.innerText = `${element.hourDuration}`
    hoursSubDiv.style.width = '70%'
...
modulesLi.innerText = `${module}`
    ...
    monthHoursDiv.append(monthSubDiv, hoursSubDiv)
    mainDiv.append(titleDiv,monthHoursDiv, modulesUl)
