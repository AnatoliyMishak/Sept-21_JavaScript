...
// divCOntainer.innerText = 'Ой чий то кінь стоїть';
// divCOntainer.classList.add('wrap', 'collapse', 'alpha', 'beta')
// divCOntainer.style.background = 'cornflowerblue';
// divCOntainer.style.color = 'white';
// divCOntainer.style.fontSize = '30px'
//
// let cloneNode = divCOntainer.cloneNode(true);
//
...
//     divCont.innerText = `${item.title} - ${item.monthDuration}`
